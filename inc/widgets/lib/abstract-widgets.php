		...
		foreach( $this->formFields as $eachFormField ) {
			...
			?>
				...
				<div class="tm-widget-image-field">
					...
					<br>
					<br>
					<a class="button tm-widget-image-upload" data-target="#<?php echo esc_attr( $this->get_field_id( $eachFormField['id'] ) ); ?>" data-preview=".tm-widget-preview-image" data-frame="select" data-state="wpc_widgets_insert_single" data-fetch="url" data-title="Insert Image" data-button="Insert" data-class="media-frame tm-widget-custom-uploader" title="Add Media"><?php echo esc_html__( 'Add Media', 'unique-elementor-addons' ); ?></a>

					<a class="button tm-widget-delete-image" data-target="#<?php echo esc_attr( $this->get_field_id( $eachFormField['id'] ) ); ?>" data-preview=".tm-widget-preview-image"><?php echo esc_html__( 'Delete', 'unique-elementor-addons' ); ?></a>
			...
			?>
				<p>
				<?php esc_html_e( 'Error! Undefined field Type.', 'unique-elementor-addons' ); ?>
				</p>
			<?php
			break;
			}
			...
			<p><?php esc_html_e( 'No options found for this widget!', 'unique-elementor-addons' ); ?></p>
		<?php }
	}
}
}