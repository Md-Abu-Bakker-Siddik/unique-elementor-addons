...
class TM_Elementor_Accordion extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Accordion', 'unique-elementor-addons' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'display_type', [
				'label' => esc_html__( "Behavior", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'accordion' =>  esc_html__( 'Accordion', 'unique-elementor-addons' ),
					'toggle'  =>  esc_html__( 'Toggle', 'unique-elementor-addons' ),
				],
				'default' => 'accordion'
			]
		);
		...
		$repeater->add_control(
			'expand',
			[
				'label' => esc_html__( "Make Expand?", 'unique-elementor-addons' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'title' => esc_html__( 'Accordion #1', 'unique-elementor-addons' ),
						'expand' => 'yes',
						'content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'unique-elementor-addons' ),
					],
					[
						'title' => esc_html__( 'Accordion #2', 'unique-elementor-addons' ),
						'content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'unique-elementor-addons' ),
					],
					[
						'title' => esc_html__( 'Accordion #3', 'unique-elementor-addons' ),
						'content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'unique-elementor-addons' ),
					],
				],
			]
		...
		$this->add_control(
			'rotate_icon',
			[
				'label' => esc_html__( 'Rotate Icon on Active', 'unique-elementor-addons' ),
		...
		$this->add_control(
			'icon_round_border',
			[
				'label' => esc_html__( "Icon Round Border?", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no'
			]
		);
		...
		$this->start_controls_tab(
			'title_style_normal',
			[
				'label' => esc_html__('Title on Normal', 'unique-elementor-addons'),
			]
		);
		...
		$this->start_controls_tab(
			'title_style_active',
			[
				'label' => esc_html__('Title on Active', 'unique-elementor-addons'),
			]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Icon on Normal', 'unique-elementor-addons'),
			]
		);
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Icon on Active', 'unique-elementor-addons'),
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			'content_padding',
			[
				'label' => esc_html__( 'Content Padding', 'unique-elementor-addons' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Wrapper on Normal', 'unique-elementor-addons'),
			]
		);
		$this->add_responsive_control(
			'wrapper__margin',
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Wrapper on Active', 'unique-elementor-addons'),
			]
		);
		$this->add_group_control(
			\Elementor\Group_Control_Background::get_type(),
