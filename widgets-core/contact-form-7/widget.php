...
class TM_Elementor_Contact_Form_7 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Contact Form 7', 'unique-elementor-addons' );
	}
	...
	protected function register_controls() {
		...
		if (!function_exists('wpcf7')) {
			$this->start_controls_section(
				'tm_global_warning',
				[
					'label' => esc_html__('Warning!', 'unique-elementor-addons'),
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'raw' => esc_html__('<strong>Contact Form 7</strong> is not installed/activated on your site. Please install and activate <strong>Contact Form 7</strong> first.', 'unique-elementor-addons'),
			...
			$this->start_controls_section(
				'section_info_box',
				[
					'label' => esc_html__('Contact Form', 'unique-elementor-addons'),
				]
			);
			$this->add_control(
				'contact_form_list',
				[
					'label' => esc_html__('Select Form', 'unique-elementor-addons'),
			...
			$this->add_control(
				'labels_switch',
				[
					'label' => esc_html__('Show Labels', 'unique-elementor-addons'),
					'type' => Controls_Manager::SWITCHER,
					'default' => 'yes',
					'label_on' => esc_html__('Show', 'unique-elementor-addons'),
					'label_off' => esc_html__('Hide', 'unique-elementor-addons'),
					'return_value' => 'yes',
				]
			);
			$this->end_controls_section();
			...
			$this->add_control(
				'form_subtitle',
				[
					'label' => esc_html__('Form Sub Title', 'unique-elementor-addons'),
					'type' => Controls_Manager::SWITCHER,
			...
			$this->add_control(
				'form_title',
				[
					'label' => esc_html__('Form Title', 'unique-elementor-addons'),
					'type' => Controls_Manager::SWITCHER,
					'label_on' => esc_html__('On', 'unique-elementor-addons'),
					'label_off' => esc_html__('Off', 'unique-elementor-addons'),
					'return_value' => 'yes',
			...
			$this->add_control(
				'form_description',
				[
					'label' => esc_html__('Form Description', 'unique-elementor-addons'),
					'type' => Controls_Manager::SWITCHER,
					'label_on' => esc_html__('On', 'unique-elementor-addons'),
					'label_off' => esc_html__('Off', 'unique-elementor-addons'),
					'return_value' => 'yes',
			...
			$this->start_controls_section(
				'section_errors',
				[
					'label' => esc_html__('Errors', 'unique-elementor-addons'),
				]
			);
			...
			$this->add_control(
				'error_messages',
				[
					'label' => esc_html__('Error Messages', 'unique-elementor-addons'),
					'type' => Controls_Manager::SELECT,
					'default' => 'show',
					'options' => [
						'show' => esc_html__('Show', 'unique-elementor-addons'),
						'hide' => esc_html__('Hide', 'unique-elementor-addons'),
					],
			...
			$this->add_control(
				'validation_errors',
				[
					'label' => esc_html__('Validation Errors', 'unique-elementor-addons'),
					'type' => Controls_Manager::SELECT,
					'default' => 'show',
					'options' => [
						'show' => esc_html__('Show', 'unique-elementor-addons'),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Form Container', 'unique-elementor-addons'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Form Alignment', 'unique-elementor-addons'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => true,
				'options' => [
					'default' => [
						'title' => esc_html__('Default', 'unique-elementor-addons'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Form Max Width', 'unique-elementor-addons'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Form Padding', 'unique-elementor-addons'),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', 'em', '%'],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Title & Description', 'unique-elementor-addons'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Heading Wrapper Style', 'unique-elementor-addons' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Form Wrapper Style', 'unique-elementor-addons' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Only Select/Dropdown Field', 'unique-elementor-addons'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__('Dropdown Arrow Color', 'unique-elementor-addons'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Placeholder Text Color', 'unique-elementor-addons'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Input, Select & Textarea', 'unique-elementor-addons'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'text_indent',
			[
				'label' => esc_html__('Text Indent', 'unique-elementor-addons'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'input_width',
			[
				'label' => esc_html__('Input Width', 'unique-elementor-addons'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'input_height',
			[
				'label' => esc_html__('Input Height', 'unique-elementor-addons'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'textarea_width',
			[
				'label' => esc_html__('Textarea Width', 'unique-elementor-addons'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'textarea_height',
			[
				'label' => esc_html__('Textarea Height', 'unique-elementor-addons'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_tab(
			'tab_fields_focus',
			[
				'label' => esc_html__('Focus', 'unique-elementor-addons'),
			]
		);
		...
		$this->start_controls_section(
			'section_label_style',
			[
				'label' => esc_html__('Labels', 'unique-elementor-addons'),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'labels_switch' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'raw' => esc_html__('if label spacing doesn\'t worked, please update label display', 'unique-elementor-addons'),
				'content_classes' => 'tm-warning',
			]
		);
		$this->add_control(
			'label_disply_type',
			[
				'label' => esc_html__('Display', 'unique-elementor-addons'),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '',
		...
		$this->add_responsive_control(
			'label_spacing',
			[
				'label' => esc_html__('Spacing', 'unique-elementor-addons'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Placeholder', 'unique-elementor-addons'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'placeholder_switch',
			[
				'label' => esc_html__('Show Placeholder', 'unique-elementor-addons'),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Radio & Checkbox', 'unique-elementor-addons'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Custom Styles', 'unique-elementor-addons'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__('Yes', 'unique-elementor-addons'),
				'label_off' => esc_html__('No', 'unique-elementor-addons'),
				'return_value' => 'yes',
		...
		$this->add_control(
			'checkbox_heading',
			[
				'label' => esc_html__('Checkbox', 'unique-elementor-addons'),
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'custom_radio_checkbox' => 'yes',
				],
		...
		$this->add_control(
			'radio_heading',
			[
				'label' => esc_html__('Radio Buttons', 'unique-elementor-addons'),
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'custom_radio_checkbox' => 'yes',
				],
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Checked', 'unique-elementor-addons'),
				'condition' => [
					'custom_radio_checkbox' => 'yes',
				],
			]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Submit Button', 'unique-elementor-addons'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => 'custom',
				'options' => [
					'full-width' => esc_html__('Full Width', 'unique-elementor-addons'),
					'custom' => esc_html__('Custom', 'unique-elementor-addons'),
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Submit Button Position', 'unique-elementor-addons'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			'spinner_icon_style',
			[
				'label' => esc_html__('After Submit Spinner Icon', 'unique-elementor-addons'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'hide_wpcf7_spinner',
			[
				'label' => esc_html__( 'Hide Spinner Icon', 'unique-elementor-addons' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Progress Range Styling (Optional)', 'unique-elementor-addons'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__('Label/Title Color', 'unique-elementor-addons'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Label/Title Typography', 'unique-elementor-addons'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Amount Color', 'unique-elementor-addons'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Amount Typography', 'unique-elementor-addons'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Progress Background Color', 'unique-elementor-addons'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Bar Background Color', 'unique-elementor-addons'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Bar Border', 'unique-elementor-addons'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Bar Handle Background Color', 'unique-elementor-addons'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Alert', 'unique-elementor-addons'),
				'condition' => [
					'error_messages' => 'show',
				],
			]
		...
		$this->start_controls_section(
			'ajaxloader_style',
			[
				'label' => esc_html__('Ajax Loader Image', 'unique-elementor-addons'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'hide_ajaxloader',
			[
				'label' => esc_html__('Hide Ajax Loader Image', 'unique-elementor-addons'),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('After Submit Feedback', 'unique-elementor-addons'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Radius', 'unique-elementor-addons'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', '%'],
				'range' => [
					'px' => [
