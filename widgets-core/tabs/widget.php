...
class TM_Elementor_Tabs extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'TM Tabs', 'unique-elementor-addons' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'expand',
			[
				'label' => esc_html__( "Make It Active/Expand?", 'unique-elementor-addons' ),
		...
		$repeater->add_control(
			'tabs_tab_icon_type',
			[
				'label' => esc_html__( 'Add Icon/Image', 'unique-elementor-addons' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'' => [
						'title' => esc_html__( 'None', 'unique-elementor-addons' ),
						'icon' => 'fa fa-ban',
					],
					'font' => [
						'title' => esc_html__( 'Icon', 'unique-elementor-addons' ),
						'icon' => 'far fa-smile',
					],
					'image' => [
						'title' => esc_html__( 'Image', 'unique-elementor-addons' ),
						'icon' => 'fa fa-image',
					]
				],
				'default' => '',
		...
		$repeater->add_control(
			...
			[
				...
				'description' => esc_html__('Select icon from Fontawesome library.', 'unique-elementor-addons'),
			]
		);
		$repeater->add_control(
		...
		$this->add_control(
			'tabs_items',
			[
				'label' => esc_html__( "Item", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'title_field' => '{{{ title }}}',
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'title' => __( 'Title 1', 'unique-elementor-addons' ),
						'expand' => 'yes',
					],
					[
						'title' => __( 'Title 2', 'unique-elementor-addons' ),
					],
					[
						'title' => __( 'Title 3', 'unique-elementor-addons' ),
					],
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tab Block - Width/Alignment', 'unique-elementor-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Horizontal Alignment", 'unique-elementor-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Each Tab Block Width", 'unique-elementor-addons' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Each Title + Icon/Image Alignment', 'unique-elementor-addons' ),
		...
		$this->add_responsive_control(
			'tabs_icon_position',
			[
				'label' => esc_html__('Icon/Image & Title Position', 'unique-elementor-addons'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'column' => [
		...
		$this->add_responsive_control(
			'title_flex_vertical',
			[
				'label' => esc_html__( "Title + Icon Vertical Alignment", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Title + Icon Horizontal Alignment", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_disply_flex_horizontal_align_elementor(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tab Block - Styling', 'unique-elementor-addons' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => '',
				],
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Idle', 'unique-elementor-addons'),
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			'title_block_margin',
			[
				'label' => esc_html__( 'Block Margin', 'unique-elementor-addons' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			'title_block_padding',
			[
				'label' => esc_html__( 'Block Padding', 'unique-elementor-addons' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Block Border Radius", 'unique-elementor-addons' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Falling Shutter Height", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'default' => [
					'unit' => '%',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border Color Options', 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			'title_styling',
			[
				'label' => esc_html__( 'Title (Tab)', 'unique-elementor-addons' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => '',
				],
		...
		$this->start_controls_section(
			'section_style_icon',
			[
				'label' => esc_html__('Icon (Tab)', 'unique-elementor-addons'),
		...
		$this->add_responsive_control(
			'tabs_icon_size',
			[
				'label' => esc_html__('Icon Font Size', 'unique-elementor-addons'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Icon Image Width', 'unique-elementor-addons'),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 26,
					'unit' => 'px',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Content Background Color', 'unique-elementor-addons'),
				'type' => Controls_Manager::COLOR,
				'dynamic' => [ 'active' => true ],
				'selectors' => [
