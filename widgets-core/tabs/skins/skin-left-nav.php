...
class Skin_Left_Nav extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Left Nav', 'unique-elementor-addons' );
	}
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'skin-left-nav-classic'	=> 	esc_html__( "Style Classic", 'unique-elementor-addons' ),
				],
				'default' => ''
			]
		);
	...
	public function register_layout_controls2( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			'wrapper_styling',
			[
				'label' => esc_html__( 'Tab & Content Placement', 'unique-elementor-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Tab & Content Flex Direction", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->start_controls_section(
			'list_icon_options',
			[
				'label' => esc_html__( 'Icon Options (Tab)', 'unique-elementor-addons' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Icon Wrapper Dimension Options', 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_control(
			'list_icon_opacity',
			[
				'label' => esc_html__( 'Icon Opacity', 'unique-elementor-addons' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 1,
		...
		$this->start_controls_section(
			'list_styling',
			[
				'label' => esc_html__( 'Text Typography/Color  (Tab)', 'unique-elementor-addons' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Wrapper of Tab Blocks', 'unique-elementor-addons' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Content Wrapper Style', 'unique-elementor-addons' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Text Color", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
