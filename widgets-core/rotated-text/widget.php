...
class TM_Elementor_Rotated_Text extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-rotated-text-style', UNIQUE_ADDONS_ASSETS_URI . '/css/widgets-core/rotated-text' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Rotated Text', 'unique-elementor-addons' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Vertical Writing Mode", 'unique-elementor-addons' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Textillate Animation on Text?", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->start_controls_section(
			'placement',
			[
				'label' => esc_html__( 'Placement', 'unique-elementor-addons' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			'color_typo',
			[
				'label' => esc_html__( 'Color/Typography', 'unique-elementor-addons' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
	...
	protected function render() {
		...
		$html = unique_addons_get_widgetcore_template_part( 'rotated-text', null, 'rotated-text/tpl', $settings, true );
