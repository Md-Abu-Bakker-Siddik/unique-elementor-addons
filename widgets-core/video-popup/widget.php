...
class TM_Elementor_Video_Popup extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'magnific-popup', UNIQUE_ADDONS_ASSETS_URI . '/js/plugins/magnific-popup/jquery.magnific-popup.min.js', array('jquery'), false, true );
		wp_register_style( 'magnific-popup', UNIQUE_ADDONS_ASSETS_URI . '/js/plugins/magnific-popup/magnific-popup.css' );
	...
	public function get_title() {
		return esc_html__( 'Video Popup', 'unique-elementor-addons' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'popup_video_url',
			[
				'label' => esc_html__( "Popup Video URL", 'unique-elementor-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Horizontal Alignment (Flex)", 'unique-elementor-addons' ),
	...
	public function register_layout_controls_play_btn() {
		$this->start_controls_section(
			'icon_styling',
			[
				'label' => esc_html__( 'Play Button Styling Options', 'unique-elementor-addons' ),
