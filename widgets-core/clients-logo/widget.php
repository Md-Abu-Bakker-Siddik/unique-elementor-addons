...
class TM_Elementor_Clients_logo extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Clients Logo', 'unique-elementor-addons' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'tm_items_section',
			[
				'label' => esc_html__( 'Items', 'unique-elementor-addons' ),
		...
		$repeater->add_control(
			'logo', [
				'label' => esc_html__( "Logo", 'unique-elementor-addons' ),
		...
		$repeater->add_control(
			'logo_url',
			[
				'label' => esc_html__( "URL", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		$repeater->add_control(
			'link_target', [
				'label' => esc_html__( "Link Target", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'_blank'  =>  esc_html__( 'Opens in a new window or tab', 'unique-elementor-addons' ),
					'_self' =>  esc_html__( 'Opens in the same window', 'unique-elementor-addons' ),
				],
				'default' => '_blank'
			]
		);
		$this->add_control(
			'clients_logo_array',
			[
				'label' => esc_html__( "Clients Logo", 'unique-elementor-addons' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Hover Animation Type", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'clients-animation-no-effect' =>  esc_html__( 'No Effect', 'unique-elementor-addons' ),
					'clients-animation-grayscale' =>  esc_html__( 'Grayscale Effect', 'unique-elementor-addons' ),
					'clients-animation-opacity' =>  esc_html__( 'Opacity Effect', 'unique-elementor-addons' ),
					'clients-animation-blur'  =>  esc_html__( 'Blur Effect', 'unique-elementor-addons' ),
					'clients-animation-zoom'  =>  esc_html__( 'Zoom Effect', 'unique-elementor-addons' ),
					'clients-animation-contrast'  =>  esc_html__( 'Contrast Effect', 'unique-elementor-addons' ),
					'clients-animation-invert'  =>  esc_html__( 'Invert Effect', 'unique-elementor-addons' ),
				],
		...
		$this->add_control(
			'rollover_effect',
			[
				'label' => esc_html__( "Make Roll Over Effect", 'unique-elementor-addons' ),
		...
		$this->add_control(
			'logo_filter_options',
			[
				'label' => esc_html__( 'Filter Options', 'unique-elementor-addons' ),
		...
		$this->start_controls_section(
			'each_logo_styling',
			[
				'label' => esc_html__( 'Each Logo Styling', 'unique-elementor-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Logo Vertical Alignment", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Logo Horizontal Alignment", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			'column_gap',
			[
				'label' => esc_html__( 'Column Gap', 'unique-elementor-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Logo Area Custom Width", 'unique-elementor-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Logo/Image Custom Width", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'separator' => 'before',
				'size_units' => [ 'px', '%' ],
				'default' => [
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('First Child', 'unique-elementor-addons'),
			]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Last Child', 'unique-elementor-addons'),
			]
		);
		$this->add_control(
