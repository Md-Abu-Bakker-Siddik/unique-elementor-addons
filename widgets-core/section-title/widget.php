...
class TM_Elementor_Section_Title extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'tm-section-title-split-text', UNIQUE_ADDONS_ASSETS_URI . '/js/widgets/section-title-split-text.js', array( 'jquery', 'gsap', 'gsap-scrolltrigger', 'gsap-splittext' ), false, true );
		wp_register_script( 'tm-section-title-text-reveal', UNIQUE_ADDONS_ASSETS_URI . '/js/widgets/section-title-text-reveal.js', array('jquery', 'gsap', 'gsap-scrolltrigger', 'gsap-splittext'), false, true );
	}
	...
	public function get_title() {
		return esc_html__( 'Section Title', 'unique-elementor-addons' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'title_appear_animation', [
				'label' => esc_html__( "Appeared Animation", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_control(
			'title_part1_slide_animation', [
				'label' => esc_html__( "On Appeared Slide Animation", 'unique-elementor-addons' ),
		...
		$this->add_control(
			'enable_gsap_text_reveal', [
				'label' => esc_html__( "Enable GSAP Text Reveal Animation", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
				'separator' => 'before',
			]
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Initial Opacity", 'unique-elementor-addons' ),
		...
		$this->add_control(
			'gsap_text_reveal_x',
			[
				'label' => esc_html__( "Initial X Offset", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'title_other_part',
			[
				'label' => esc_html__( 'Other Parts', 'unique-elementor-addons' ),
		...
		$repeater->add_responsive_control(
			'title_bg_img_size',
			[
				'label' => esc_html__( "Background Image Size", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', '%'],
				'range' => [
					'px' => [
		...
		$repeater->add_control(
			'cursor_mouseover_image', [
				'label' => esc_html__( "Cursor Mouse Over Image", 'unique-elementor-addons' ),
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Paste URL or type', 'unique-elementor-addons' ),
			]
		);
		$this->add_control(
			'title_list',
			[
				'label' => esc_html__( "Title Other Parts", 'unique-elementor-addons' ),
		...
		$this->add_control(
			'enable_typed_text_effect', [
				'label' => esc_html__( "Enable Typed Text Effect using these parts", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Typed Text Effect Options', 'unique-elementor-addons' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
				'condition' => [
		...
		$this->add_control(
			'typed_loop', [
				'label' => esc_html__( "Autotype loop", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_off' => __( 'Off', 'unique-elementor-addons' ),
				'label_on' => __( 'On', 'unique-elementor-addons' ),
				'return_value' => '1',
				'default' => '1',
				'condition' => array(
					'enable_typed_text_effect' => array('yes')
		...
		$this->add_control(
			'typed_cursor', [
				'label' => esc_html__( "Autotype cursor", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_off' => __( 'Off', 'unique-elementor-addons' ),
				'label_on' => __( 'On', 'unique-elementor-addons' ),
				'return_value' => '1',
		...
		$this->add_control(
			'typed_cursor_char', [
				'label' => esc_html__( "Autotype cursor character", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::TEXT,
		...
		$this->add_control(
			'typed_speed',
			[
				'label' => esc_html__( "Autotype speed", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'label' => __('Autotype speed', 'unique-elementor-addons'),
				'condition' => array(
					'enable_typed_text_effect' => array('yes')
				),
				'default' => array(
		...
		$this->add_control(
			'typed_delay',
			[
				'label' => esc_html__( "Autotype delay (in sec.)", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'separator' => 'after',
				'condition' => array(
					'enable_typed_text_effect' => array('yes')
		...
		$this->add_control(
			'sub_title_text',
			[
				'label' => esc_html__( "Sub Title Text", 'unique-elementor-addons' ),
				"description" => esc_html__( "It will be displayed above/under title", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::TEXTAREA,
				'default' => esc_html__( "This is a Sub Title.", 'unique-elementor-addons' ),
				'condition' => [
		...
		$this->add_control(
			'sub_title_position',
			[
				'label' => esc_html__( "Sub Title Position", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'above-title' => esc_html__( 'Above Title', 'unique-elementor-addons' ),
					'below-title' => esc_html__( 'Below Title', 'unique-elementor-addons' ),
				],
				'default' => 'above-title',
				'condition' => [
					'show_subtitle' => array('yes')
		...
		$this->add_control(
			...
			'type' => \Elementor\Controls_Manager::TEXT,
			"description" => esc_html__( 'To style particular content element.', 'unique-elementor-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'style1' => esc_html__( 'Style 1 - Default', 'unique-elementor-addons' ),
				],
				'default' => 'style1'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Horizontal Line Options', 'unique-elementor-addons' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'line_bottom_style',
			[
				'label' => esc_html__( "Horizontal Line Bottom Style", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					''	=> 	esc_html__( "No", 'unique-elementor-addons' ),
					'line-left-current-theme'	=> 	esc_html__( "Style Left - Current Theme", 'unique-elementor-addons' ),
					'line-left-current-theme-white'	=> 	esc_html__( "Style Left - Current Theme White", 'unique-elementor-addons' ),
					'line-right-current-theme'	=> 	esc_html__( "Style Right - Current Theme", 'unique-elementor-addons' ),
					'line-right-current-theme-white'	=> 	esc_html__( "Style Right - Current Theme White", 'unique-elementor-addons' ),
					'line-center-current-theme'	=> 	esc_html__( "Style Center - Current Theme", 'unique-elementor-addons' ),
					'line-center-current-theme-white'	=> 	esc_html__( "Style Center White - Current Theme", 'unique-elementor-addons' ),
				],
				'default' => ''
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Line Horizontal Alignment', 'unique-elementor-addons'),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'left',
				'options' => [
					'left' => [
		...
		$this->add_responsive_control(
			'vertical_line_align',
			[
				'label' => esc_html__('Line Vertical Alignment', 'unique-elementor-addons'),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'bottom',
				'options' => [
					'bottom' => [
						'title' => esc_html__('Bottom', 'unique-elementor-addons'),
						'icon' => 'eicon-v-align-bottom',
					],
					'top' => [
						'title' => esc_html__('Top', 'unique-elementor-addons'),
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('After', 'unique-elementor-addons'),
			]
		);
		$this->add_control(
			'horizontal_line_after_bg_color',
			[
				'label' => esc_html__( "Color (After)", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Theme Color (After)", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Before', 'unique-elementor-addons'),
			]
		);
		$this->add_control(
			'horizontal_line_before_bg_color',
			[
				'label' => esc_html__( "Color (Before)", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Theme Color (Before)", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			'title_icon_options',
			[
				'label' => esc_html__( 'Title Icon', 'unique-elementor-addons' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'show_title_icon',
			[
				'label' => esc_html__( "Show Title Icon?", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'icon-left'  => esc_html__( 'Left of Subtitle', 'unique-elementor-addons' ),
				],
				'default' => 'icon-top',
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Icon Custom Width", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', '%'],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Title Background Image Options', 'unique-elementor-addons' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Sub Title Styling', 'unique-elementor-addons' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'subtitle_text_color',
			[
				'label' => esc_html__( "Sub Title Text Color", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Sub Title Text Color (Hover)", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Sub Title Theme Colored", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Sub Title Theme Colored (Hover)", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			'subtitle_margin',
			[
				'label' => esc_html__( 'Sub Title Margin', 'unique-elementor-addons' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Title Shadow Text', 'unique-elementor-addons' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( "Title Shadow Text", 'unique-elementor-addons' ),
				"description" => esc_html__( "It will be displayed behind the title as a big blurred gray text", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( "Enable Text Textillate Animation on Text?", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Title Shadow Text Styling', 'unique-elementor-addons' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Text Container Width", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', '%'],
				'range' => [
					'px' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Position', 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Paragraph Theme Colored", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Paragraph Theme Colored (Hover)", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_theme_color_list(),
				'default' => '',
				'selectors' => [
