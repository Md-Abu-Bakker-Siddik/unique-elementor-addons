(function($) {
	"use strict";
	var UNIQUE_ADDONS_LIGHT_GALLERY = {};
	...
	UNIQUE_ADDONS_LIGHT_GALLERY.initialize = {

		init: function() {
			UNIQUE_ADDONS_LIGHT_GALLERY.initialize.TM_lightgallery_lightbox();
			UNIQUE_ADDONS_LIGHT_GALLERY.initialize.TM_lightgallery_lightbox_reset();
		},
	...
	/* ---------------------------------------------------------------------- */
	//document ready
	UNIQUE_ADDONS_LIGHT_GALLERY.documentOnReady = {
		init: function() {
			UNIQUE_ADDONS_LIGHT_GALLERY.initialize.init();
		}
	};
	...
	/* ---------------------------------------------------------------------- */
	$document.ready(
		UNIQUE_ADDONS_LIGHT_GALLERY.documentOnReady.init
	);
