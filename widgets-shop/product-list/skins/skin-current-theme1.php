<?php
namespace UniqueAddons\Widgets\Product_List\Skins;
...
class Skin_Current_Theme1 extends Elementor_Skin_Base {
    ...
    private function woocommerce_default($settings) {
        ...
        $html = unique_addons_get_shortcode_shop_template_part( 'product-list-current-theme1', null, 'product-list/tpl', $settings, true );
