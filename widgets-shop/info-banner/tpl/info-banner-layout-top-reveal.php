		...
		<div class="info-banner-text-holder-wrapper">
			<div class="info-banner-text-holder">
				<div class="info-banner-text-holder-inner">
					<?php unique_addons_get_shortcode_shop_template_part( 'subtitle', null, 'info-banner/tpl', $settings, false );?>
					<?php unique_addons_get_shortcode_shop_template_part( 'title', null, 'info-banner/tpl', $settings, false );?>

					<div class="content-holder">
						<?php unique_addons_get_shortcode_shop_template_part( 'content', null, 'info-banner/tpl', $settings, false );?>
						<?php if ( $show_view_details_button == 'yes' ) : ?>
						<?php unique_addons_get_shortcode_shop_template_part( 'button', null, 'info-banner/tpl', $settings, false );?>
						<?php endif; ?>
					</div>
				</div>
			</div>
