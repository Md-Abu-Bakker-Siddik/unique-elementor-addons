<?php
namespace UniqueAddons\Widgets\Products_Category\Skins;
...
class Skin_Current_Theme2 extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		add_action( 'elementor/element/uae-product-category/paragraph_opt/after_section_end', [ $this, 'register_layout_controls1' ] );
	}
	...
	public function get_title() {
		return __( 'Skin - Current Theme2', 'unique-elementor-addons' );
	}
	...
	public function register_layout_controls1( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Background Option (Current Theme2 Skin)', 'unique-elementor-addons'),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Wrapper Border Color', 'unique-elementor-addons'),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Wrapper Border Theme Colored", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Top Image Circle Background', 'unique-elementor-addons'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Link Button Color', 'unique-elementor-addons'),
				'type'  => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Footer Text Color/Typo', 'unique-elementor-addons'),
				'type'  => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Text Height', 'unique-elementor-addons'),
				'type'       => \Elementor\Controls_Manager::SLIDER,
				'range'      => [
					'px' => [
						'min' => 0,
