...
class Skin_Style2 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-award-block-skin-style2', UNIQUE_ADDONS_ASSETS_URI . '/css/shortcodes/award-block/award-block-skin-style2' . $direction_suffix . '.css' );
		wp_register_script( 'award-block2', UNIQUE_ADDONS_ASSETS_URI . '/js/widgets/award-block2.js', array( 'jquery' ), false, true );
