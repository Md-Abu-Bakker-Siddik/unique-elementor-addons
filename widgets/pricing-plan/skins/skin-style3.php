...
class Skin_Pricing_Style3 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Pricing Style3', 'unique-elementor-addons' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-pricing-skin-style3', UNIQUE_ADDONS_ASSETS_URI . '/css/shortcodes/pricing-plan/pricing-skin-style3' . $direction_suffix . '.css' );
