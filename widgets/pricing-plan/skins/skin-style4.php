...
class Skin_Pricing_Style4 extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		add_action( 'elementor/element/uae-pricing-plan/tm_general/after_section_end', [ $this, 'register_layout_controls' ] );
	}
	...
	public function get_title() {
		return __( 'Skin Pricing Style4', 'unique-elementor-addons' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-pricing-skin-style4', UNIQUE_ADDONS_ASSETS_URI . '/css/shortcodes/pricing-plan/pricing-skin-style4' . $direction_suffix . '.css' );
