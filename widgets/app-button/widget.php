...
class TM_Elementor_App_Button extends Widget_Base {
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'tm-app-button', UNIQUE_ADDONS_ASSETS_URI . '/css/shortcodes/app-button' . $direction_suffix . '.css' );
    }
	...
	public function get_title() {
		return esc_html__( 'TM - App Button', 'unique-elementor-addons' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .tm-app-btn' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		...
		$html = unique_addons_get_shortcode_template_part( 'app-button', null, 'app-button/tpl', $settings, true );
