...
class Skin_Creative1 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Creative 1', 'unique-elementor-addons' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Link Color Options', 'unique-elementor-addons' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Each Item Options', 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
