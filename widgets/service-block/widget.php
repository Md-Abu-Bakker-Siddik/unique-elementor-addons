...
class TM_Elementor_ServiceBlock extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Service Block', 'unique-elementor-addons' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'service_icons_options', [
				'label' => esc_html__( 'Service Items', 'unique-elementor-addons' ),
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Service Icon Section', 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		$repeater->add_control(
			'icon_type',
			[
				'label' => esc_html__( "Service Icon Type", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
		...
		$repeater->add_control(
			'service_icon_image',
			[
				'label' => esc_html__( "Icon Type - Image", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Icon Type - Image (Hover)", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'description' => esc_html__( "This image will be shown on the top of the pricing table", 'unique-elementor-addons' ),
				'condition' => [
					'icon_type' => array('image')
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Icon Type - Image Size", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_get_available_image_sizes(),
				'default' => 'full',
				'condition' => [
		...
		$repeater->add_responsive_control(
			...
			[
				'label' => esc_html__( "Icon Image Custom Width", 'unique-elementor-addons' ),
		...
		$this->add_control(
			'display_type', [
				...
				'options' => [
					...
					'basic2'  =>  esc_html__( 'Basic2', 'unique-elementor-addons' ),
					'creative-style1'  =>  esc_html__( 'Creative Style1', 'unique-elementor-addons' )
				],
				'default' => 'grid'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'GSAP Pin Settings', 'unique-elementor-addons' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'tm_gsap_pin', [
				'label' => esc_html__( "Enable GSAP Pin", 'unique-elementor-addons' ),
