<?php
namespace UniqueAddons\Widgets\PricingBlock;
...
class TM_Elementor_PricingBlock extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-pricing-block-loader', UNIQUE_ADDONS_ASSETS_URI . '/css/shortcodes/pricing-block/pricing-block-loader' . $direction_suffix . '.css' );
			wp_enqueue_script( 'tm-pricing-block-script', UNIQUE_ADDONS_ASSETS_URI . '/js/widgets/pricing-block.js' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Pricing Block', 'unique-elementor-addons' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'pricing_icons_options', [
				'label' => esc_html__( 'Pricing Items', 'unique-elementor-addons' ),
		...
		$repeater->add_control(
			'image_position', [
				'label' => esc_html__( "Image/Icon Position", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
			...
			[
				...
				'default' => [
					[
						...
						'price' => esc_html__( '$20.00', 'unique-elementor-addons' ),
					],
					[
	...
	protected function render() {
		...
		$settings['holder_id'] = unique_addons_get_isotope_holder_ID('pricing-block');

		$settings['settings'] = $settings;


		//Produce HTML version by using the parameters (filename, variation, folder name, parameters, shortcode_ob_start)
		$html = unique_addons_get_shortcode_template_part( 'pricing', $settings['display_type'], 'pricing-block/tpl', $settings, true );
