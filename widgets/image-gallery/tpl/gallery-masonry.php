			...
			<div class="isotope-layout-inner">
				...
				<?php
					...
					if ( isset($gallery_item['image_size']) && !empty($gallery_item['image_size'])) {
						...
						if ( 'large-wide' === $image_size || 'uae_wide' === $image_size ) {
							$image_size = 'tm-masonry-large-wide';
						} elseif ( 'large-width-height' === $image_size || 'uae_width_height' === $image_size ) {
				...
				<div class="isotope-item <?php echo esc_attr( $image_size );?> elementor-repeater-item-<?php echo esc_attr( $gallery_item['_id'] );?>">
					<div class="isotope-item-inner">
						<?php unique_addons_get_shortcode_template_part( 'each-item', $_skin, 'image-gallery/tpl', $settings, false ); ?>
					</div>
				</div>
				<!-- Isotope Item End -->
				<?php } ?>
