...
<div class="tm-image-gallery tm-gallery-item-currenty-style2">
	<div class="inner-box">
		...
		<div class="info-box">
			<?php unique_addons_get_shortcode_template_part( 'part-title', null, 'image-gallery/tpl', $gallery_item, false );?>
			<?php unique_addons_get_shortcode_template_part( 'part-subtitle', null, 'image-gallery/tpl', $gallery_item, false );?>
		</div>
	</div>
</div>