...
class TM_Elementor_TestimonialBlock extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonial Block', 'unique-elementor-addons' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'testimonial_icons_options', [
				'label' => esc_html__( 'Testimonial Items', 'unique-elementor-addons' ),
		...
		$repeater->add_control(
			'name',
			[
				'label' => esc_html__( "Author Name", 'unique-elementor-addons' ),
		...
		$repeater->add_control(
			'position',
			[
				'label' => esc_html__( "Author Position", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "Designer", 'unique-elementor-addons' ),
			]
		);
		$repeater->add_control(
			'title',
			[
				'label' => esc_html__( "Reason/Title (Optional)", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		$repeater->add_control(
			'rating',
			[
				'label' => esc_html__( 'Rating Value', 'unique-elementor-addons' ),
		...
		$repeater->add_control(
			'content',
			[
				'label' => esc_html__( "Testimonial Text", 'unique-elementor-addons' ),
		...
		$repeater->add_control(
			'feature_image',
			[
				'label' => esc_html__( "Author Thumbnail Image", 'unique-elementor-addons' ),
		...
		$repeater->add_control(
			'feature_image_size',
			[
				'label' => esc_html__( "Choose Thumbnail Image Size", 'unique-elementor-addons' ),
			...
			[
				...
				'default' => [
					[
						...
						'position' => esc_html__( 'position #1', 'unique-elementor-addons' ),
					...
					[
						...
						'position' => esc_html__( 'Title #2', 'unique-elementor-addons' ),
						'featured_image' => Utils::get_placeholder_image_src(),
						'content' => esc_html__( 'Item content. Click the edit button to change this text.', 'unique-elementor-addons' ),
					...
					[
						...
						'position' => esc_html__( 'Title #3', 'unique-elementor-addons' ),
						'featured_image' => Utils::get_placeholder_image_src(),
						'content' => esc_html__( 'Item content. Click the edit button to change this text.', 'unique-elementor-addons' ),
		...
		$this->add_control(
			'icon',
			[
				'label' => __('Testimonial Icon', 'unique-elementor-addons'),
		...
		$this->add_control(
			'icon_image',
			[
				'label' => esc_html__( 'Testimonial Image', 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'condition' => [
					'icon_type' => 'image',
				],
		...
		$this->add_control(
			'position_tag',
			[
				'label' => esc_html__( "Position Tag", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_heading_tag_list(),
				'default' => 'div'
			]
		...
		$this->add_control(
			'title_tag',
			[
				'label' => esc_html__( "Reason/Title Tag", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_heading_tag_list(),
				'default' => 'h5'
			]
		...
		$this->add_control(
			'show_author_name', [
				'label' => esc_html__( "Show Author Name", 'unique-elementor-addons' ),
		...
		$this->add_control(
			'show_author_position', [
				'label' => esc_html__( "Show Author Position", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		$this->add_control(
			'show_title', [
				'label' => esc_html__( "Show Reason/Title", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		$this->add_control(
			'show_rating', [
				'label' => esc_html__( "Show Rating", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Author Name Styling', 'unique-elementor-addons' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Author Position Styling', 'unique-elementor-addons' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Author Text Styling', 'unique-elementor-addons' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Reason/Title Styling', 'unique-elementor-addons' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
