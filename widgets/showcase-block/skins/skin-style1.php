<?php
namespace UniqueAddons\Widgets\ShowcaseBlock\Skins;
...
class Skin_Style1 extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		add_action( 'elementor/element/uae-showcase-block/tm_general/after_section_end', [ $this, 'register_layout_controls' ] );
	}
