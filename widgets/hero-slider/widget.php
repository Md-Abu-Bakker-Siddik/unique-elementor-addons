...
class TM_Elementor_HeroSlider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'TM Hero Slider', 'unique-elementor-addons' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'hero_slider_options', [
				'label' => esc_html__( 'Hero Items', 'unique-elementor-addons' ),
		...
		$repeater->add_control(
			'link_text',
			[
				'label' => esc_html__( "Link Text", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_html__( "Read more", 'unique-elementor-addons' ),
			]
		);
		$repeater->add_control(
			'feature_link',
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Featured Image Section', 'unique-elementor-addons' ),
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Thumbnail Image Size", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_get_available_image_sizes(),
				'default' => 'thumbnail',
			]
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Hero Slider Items", 'unique-elementor-addons' ),
				...
				'default' => [
					...
					[
						...
						'subtitle' => esc_html__( 'Subtitle #2', 'unique-elementor-addons' ),
						'featured_image' => Utils::get_placeholder_image_src(),
						'content' => esc_html__( 'Item content. Click the edit button to change this text.', 'unique-elementor-addons' ),
					],
					[
						'title' => esc_html__( 'Title #3', 'unique-elementor-addons' ),
						'subtitle' => esc_html__( 'Subtitle #3', 'unique-elementor-addons' ),
						'featured_image' => Utils::get_placeholder_image_src(),
						'content' => esc_html__( 'Item content. Click the edit button to change this text.', 'unique-elementor-addons' ),
					],
				],
		...
		$this->start_controls_section(
			'tm_animation',
			[
				'label' => esc_html__( 'Slider Default Settings', 'unique-elementor-addons' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'slider_animation', [
				'label'        => __( 'Slider Animation', 'unique-elementor-addons' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => __( 'Show', 'unique-elementor-addons' ),
				'label_off'    => __( 'Hide', 'unique-elementor-addons' ),
				'default'      => 'yes',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'label'   => esc_html__( 'Slider Content Width', 'unique-elementor-addons' ),
				'size_units' => [ '%', 'px' ],
				'range' => [
					'%' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'slider_padding',
			[
				'label'      => __( 'Slider Padding', 'unique-elementor-addons' ),
		...
		$this->add_control(
			'show_subtitle', [
				'label' => esc_html__( "Show Subtitle", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		...
		$this->add_control(
			'show_button', [
				'label' => esc_html__( "Show Button", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		$this->add_control(
			'show_thumb', [
				'label'        => __( 'Show Thumb', 'unique-elementor-addons' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => __( 'Show', 'unique-elementor-addons' ),
				'label_off'    => __( 'Hide', 'unique-elementor-addons' ),
				'default'      => 'yes',
		...
		$this->add_control(
			'show_thumb_img', [
				'label' => esc_html__( "Show Thumb Image", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition'   => [
						'show_thumb' => [ 'yes' ]
		...
		$this->add_control(
			'show_thumb_title', [
				'label' => esc_html__( "Show Thumb Text", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition'   => [
						'show_thumb' => [ 'yes' ]
		...
		$this->add_responsive_control(
			'content_alignment',
			[
				'label' => esc_html__( "Content Alignment", 'unique-elementor-addons' ),
		...
		$this->add_responsive_control(
			'thumb_alignment',
			[
				'label' => esc_html__( "Thumb Alignment", 'unique-elementor-addons' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => unique_addons_text_align_choose(),
				'selectors' => [
		...
		$this->start_controls_section(
			'tm_thumb_settings',
			[
				'label' => esc_html__( 'Thumb Settings', 'unique-elementor-addons' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
			...
			[
				'type'    => Controls_Manager::SLIDER,
				'label'   => esc_html__( 'Thumb Wrapper Width', 'unique-elementor-addons' ),
				'size_units' => [ '%', 'px' ],
				'range' => [
					'%' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			...
			[
				'type'    => Controls_Manager::SLIDER,
				'label'   => esc_html__( 'Thumb Height', 'unique-elementor-addons' ),
				'size_units' => [ '%', 'px' ],
				'range' => [
					'%' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'thumb_margin',
			[
				'label'      => __( 'Thumb Box Margin', 'unique-elementor-addons' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			'thumb_padding',
			[
				'label'      => __( 'Thumb Box Padding', 'unique-elementor-addons' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Image Overlay  Color", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Thumb Title Styling', 'unique-elementor-addons' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
