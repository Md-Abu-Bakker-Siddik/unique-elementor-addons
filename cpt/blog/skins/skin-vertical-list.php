...
class Skin_Vertical_List extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Style - Vertical List', 'unique-elementor-addons' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			'vertical_list-options', [
				'label' => esc_html__( 'Vertical List Options', 'unique-elementor-addons' ),
		...
		$this->add_responsive_control(
			'thumb_border_radius',
			[
				'label' => esc_html__( 'Thumb Border Radius', 'unique-elementor-addons' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			'padding',
			[
				'label' => esc_html__( 'List Padding', 'unique-elementor-addons' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			'margin',
			[
				'label' => esc_html__( 'List Margin', 'unique-elementor-addons' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Last Item', 'unique-elementor-addons'),
			]
		);
		$this->add_control(
