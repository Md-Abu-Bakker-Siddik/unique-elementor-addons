...
class Skin_Style_Current_Theme2 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme2', 'unique-elementor-addons' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Icon Color", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Icon Bg Color", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Background Options (Hover)', 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Icon Options (Hover)', 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme2', UNIQUE_ADDONS_ASSETS_URI . '/css/cpt/projects/project-skin-current-theme2' . $direction_suffix . '.css' );
