<?php
namespace UniqueAddons\Widgets\Projects\Skins;
...
class Skin_Style_Current_Theme4 extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		add_action( 'elementor/element/uae-cpt-projects/tm_general/after_section_end', [ $this, 'register_layout_controls' ] );
	}
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme4', 'unique-elementor-addons' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Current Background Styling', 'unique-elementor-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .projects-current-theme4 .inner-box' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .projects-current-theme4 .inner-box' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Current Icon Styling', 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Button BG Color", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Button Icon Color", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Current Background Styling ( Hover )', 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .projects-current-theme4 .inner-box:before' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .projects-current-theme4 .inner-box:before' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Current Icon Styling ( Hover )', 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Button Icon Color (Hover)", 'unique-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme4', UNIQUE_ADDONS_ASSETS_URI . '/css/cpt/projects/project-skin-current-theme4' . $direction_suffix . '.css' );

		wp_enqueue_script( 'tm-projects-block-script', UNIQUE_ADDONS_ASSETS_URI . '/js/cpt/project-block4.js', array('jquery'), false, true );
