...
class Skin_Style_Current_Theme5 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme5', 'unique-elementor-addons' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme5', UNIQUE_ADDONS_ASSETS_URI . '/css/cpt/projects/project-skin-current-theme5' . $direction_suffix . '.css' );
