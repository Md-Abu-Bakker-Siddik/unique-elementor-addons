...
class Skin_Style_Current_Theme3 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme3', 'unique-elementor-addons' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme3', UNIQUE_ADDONS_ASSETS_URI . '/css/cpt/projects/project-skin-current-theme3' . $direction_suffix . '.css' );
		wp_enqueue_script( 'tm-project-block-bg-image', UNIQUE_ADDONS_ASSETS_URI . '/js/cpt/project-block-bg-image.js', array('jquery'), false, true );
